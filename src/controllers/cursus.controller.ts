...
import {
  ...
  updateCursus,
} from "../services/cursus.service.js";
...
import {
  ...
  getUsersWhoHaveUserCursusForThisTheme,
 ...
 */
export async function getAllCursusController(
  req: Request,
  res: Response
 ...
 */
export async function getCursusController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<CursusData>>> {
 ...
 */
export async function changeOrderCursusController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<CursusData[] | any>>> {
  if (!req.params.id)
    throw new AppError(
      400,
 ...
 */
export async function addCursusController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<CursusData[]>>> {
 ...
 */
export async function deleteCursusController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<CursusData[]>>> {
  if (!req.params.id)
  ...
  const usersWhoHaveUserCursusForThisTheme =
    await getUsersWhoHaveUserCursusForThisTheme(themeId);
 ...
 * @throws {AppError} If cursus ID URL parameter is not provided.
 */
export async function updateCursusController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<CursusData[]>>> {
  if (!req.params.id)
