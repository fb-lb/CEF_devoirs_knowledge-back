 ...
 */
export async function getAllThemesController(
  req: Request,
  res: Response
 ...
 */
export async function changeOrderThemesController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<ThemeData[] | any>>> {
  if (!req.params.id)
    throw new AppError(
      400,
 ...
 * - Get all theme informations,
 */
export async function addThemeController(
  req: Request,
  res: Response
): Promise<Response<ApiResponse<ThemeData[]>>> {
