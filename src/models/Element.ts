...
interface ElementCreationAttributes extends Optional<ElementAttributes, 'id' | 'createdAt' | 'updatedAt' | 'updatedBy' | 'IncludedInLesson' | 'UpdatedByUser' | 'IncludesTexts' | 'IncludesImages'> {}
