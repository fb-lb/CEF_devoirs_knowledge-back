...
Defined in: [src/controllers/user-lesson.controller.ts:25](https://github.com/fb-lb/CEF_devoirs_knowledge-back/blob/c8c533ab6fd4749c61887011f2eaf102002dd722/src/controllers/user-lesson.controller.ts#L25)
