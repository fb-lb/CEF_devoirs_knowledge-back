...
Defined in: [src/controllers/user-cursus.controller.ts:189](https://github.com/fb-lb/CEF_devoirs_knowledge-back/blob/92bce3fddfb9a7cbf0a922fbf3e1fb365cc1842a/src/controllers/user-cursus.controller.ts#L189)
