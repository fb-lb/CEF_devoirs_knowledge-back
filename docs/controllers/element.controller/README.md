...
[knowledge-back](../../modules.md) / controllers/element.controller

# controllers/element.controller

## Functions

- [addImageController](functions/addImageController.md)
- [addTextController](functions/addTextController.md)
- [changeOrderElementsController](functions/changeOrderElementsController.md)
