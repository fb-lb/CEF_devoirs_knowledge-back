...
Defined in: [src/controllers/user-theme.controller.ts:47](https://github.com/fb-lb/CEF_devoirs_knowledge-back/blob/92bce3fddfb9a7cbf0a922fbf3e1fb365cc1842a/src/controllers/user-theme.controller.ts#L47)
